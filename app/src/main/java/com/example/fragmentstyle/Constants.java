...
public interface Constants {
    ...
    String ROBOT_COMMAND_ROTATE_LEFT = ROBOT_COMMAND_PREFIX_ARDUINO + "A1";
    String ROBOT_COMMAND_ROTATE_RIGHT = ROBOT_COMMAND_PREFIX_ARDUINO + "D1";
    String ROBOT_COMMAND_BEGIN_EXPLORATION = "exs";
